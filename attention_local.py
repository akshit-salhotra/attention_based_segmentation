...
class U2NETP(nn.Module):
    ...
    def forward(self,x):
        ...
        #ir images downsampling
        if self.flag:
            ir2=downsample_like(ir,hx2)
            ir3=downsample_like(ir,hx3)
            ir4=downsample_like(ir,hx4)
            ir5=downsample_like(ir,hx5)
...
if __name__=='__main__':
    ...
    summary(model,(4,300,300),1,device='cuda')
